    ...
    <section className="relative h-screen w-full overflow-hidden bg-neutral-900 flex items-center justify-center">
      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 opacity-[0.05] pointer-events-none mix-blend-overlay hidden md:block"
      ...
      <motion.div
        ...
        className="relative z-10 bg-white shadow-2xl w-[90%] md:w-auto max-w-4xl mx-auto"
      >
        {/* Decorative Frame */}
        ...
        <div className="px-8 py-16 md:px-20 md:py-20 flex flex-col items-center justify-center text-center">
          ...
          <motion.div style={{ y: yText }}>
            ...
            <div className="flex items-center justify-center gap-4 mb-4 opacity-60">
              ...
              <span className="text-[9px] uppercase tracking-[0.3em] font-sans font-semibold">Model Management</span>
              <div className="h-[1px] w-12 bg-black"></div>
            </div>
          </motion.div>
