    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full">
        <img
          ...
          loading="lazy"
          className={cn(
            "w-full h-full object-cover transition-all duration-700 ease-[cubic-bezier(0.25,1,0.5,1)] will-change-transform",
            "md:grayscale-[20%] group-hover:grayscale-0 group-hover:scale-105",
      ...
      <button
        ...
        className={cn(
          "absolute top-4 right-4 z-30 w-10 h-10 rounded-full flex items-center justify-center md:backdrop-blur-md border transition-all duration-300",
          isSelected
